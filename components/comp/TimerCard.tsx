...
import { TimerCardProps, EditableProps } from '@/types/typeDeclaration';
                    ...
                    return (
                        <button
                            ...
                            className={classNames(
                                ...
                                isSelected ? `bg-[${type.color}] text-white shadow-md` : 'bg-gray-800/80 text-gray-300 hover:bg-gray-700'
                            )}
                        >
...
function TimerCard({
    ...
    return (
        <div className="bg-[#1E1E1E] rounded-2xl p-6 shadow-lg border border-white/10 relative overflow-hidden">
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-linear-to-bl from-[#8A2BE2]/20 to-transparent rounded-full"></div>
            {sessionState === 'idle' ? (
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        ...
                        <button onClick={handleStart} className="px-10 py-4 rounded-full bg-linear-to-r from-[#8A2BE2] to-[#5D3FD3] text-white font-bold text-base shadow-lg shadow-[#8A2BE2]/30 hover:opacity-90 transition-opacity cursor-pointer">Start Focus</button>
